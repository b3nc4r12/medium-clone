...
const Post: NextPage<Props> = ({ post }) => {
  ...
  return (
    <main>
      ...
      {submitted ? (
        <h1 className="text-2xl font-bold text-yellow-500 max-w-2xl mx-auto text-center">Thank you for your submission! Your comment is awating approval and will be shown publically once approved!</h1>
      ) : (
